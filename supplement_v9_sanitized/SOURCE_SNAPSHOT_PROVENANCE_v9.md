...
The public source snapshot is compared against the source tree used for the v1.0.7 revision experiments.
...
- run_opening_report_complete.py preserves the distinction between explicit instruction trials and the free scene-selection trial; it does not backfill a requested target into the latter.
