...
def build_command(args: argparse.Namespace, case: dict, seed: int) -> list[str]:
    ...
    command = [
        ...
        "--vlm_backend", "openai", "--openai_model", args.openai_model,
        "--openai_wire_api", args.openai_wire_api,
        "--openai_api_key_env", args.openai_api_key_env, "--openai_timeout", "600",
...
def main() -> None:
    ...
    manifest = {
        ...
        "model": args.openai_model, "wire_api": args.openai_wire_api,
