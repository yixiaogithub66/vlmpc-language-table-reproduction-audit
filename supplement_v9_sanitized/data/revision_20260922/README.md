...
- semantic_mpc_condition_statistics_v9.csv: condition-level aggregates for the 18-run semantic suite, including 17/17 request-selection matches and instruction-level joint successes among 17 explicit-target rows, plus one scene-selection row reported as N/A for instruction metrics.
