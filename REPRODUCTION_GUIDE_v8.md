...
From this manuscript directory:
    ...
    scripts/plot_paper_figures.py    reproducible figure renderer
...
All means and standard deviations in the revised tables use the sample SD convention. Superseded Semantic MPC rows and the conflicting 5/18 threshold table are excluded from v1.0.4. The package-level verification script fails if those files reappear.
