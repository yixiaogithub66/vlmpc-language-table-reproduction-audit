...
- figures/method_pipeline_v9.pdf
- figures/final_distance_distribution_v9.pdf
- figures/threshold_sensitivity_v9.pdf
- figures/target_event_audit_v9.pdf
- figures/qualitative_frames_v9.png
...
- data/raw_controller_multiseed_v9.csv
- data/semantic_mpc_live_runs_v9.csv
- data/threshold_sensitivity_v9.csv
- data/archived_nonsemantic_branch_runs_v8.csv
- data/method_parameter_table_v2.csv
- data/runtime_asset_manifest_v9.csv
...
- supplement_v9_sanitized/data/robustness_edge_audit/manifest_v9.json
- supplement_v9_sanitized/data/robustness_edge_audit/original.png
- supplement_v9_sanitized/data/robustness_edge_audit/occluded_target.png
- supplement_v9_sanitized/data/robustness_edge_audit/viewpoint_proxy.png
- supplement_v9_sanitized/data/robustness_edge_audit/brightness_shift.png
...
- REPRODUCTION_GUIDE_v9.md
- DATA_CODE_AVAILABILITY_v9.md
- EXPERIMENT_RESULTS_INDEX_v9.md
- README_SUBMISSION_v9.md
- CITATION.cff
- CHANGELOG.md

The verifier is the authoritative final-integrity check. Superseded v8 aggregate files and empty event files are intentionally absent. The list below is the complete portable file set for this release, excluding Git metadata, local LaTeX build intermediates, and workspace-only `tmp/` or `__pycache__/` directories.
...
- data/threshold_sensitivity_v9.csv
- figures/final_distance_distribution_v9.pdf
- figures/final_distance_distribution_v9.png
- figures/method_pipeline_v9.pdf
- figures/method_pipeline_v9.png
- figures/qualitative_frames_v9.png
- figures/source/qualitative_frame_0.png
- figures/source/qualitative_frame_11.png
- figures/source/qualitative_frame_22.png
- figures/target_event_audit_v9.alignment.json
- figures/target_event_audit_v9.alignment.svg
- figures/target_event_audit_v9.pdf
- figures/target_event_audit_v9.png
- figures/threshold_sensitivity_v9.pdf
- figures/threshold_sensitivity_v9.png
- main.pdf
- main.tex
- refs.bib
- scripts/import_live_results_v9.py
...
- supplement_v9_sanitized/SOURCE_SNAPSHOT_PROVENANCE_v9.md
- supplement_v9_sanitized/data/code_manifest_v9.csv
- supplement_v9_sanitized/data/grounded_action_replacement_summary_v9.csv
- supplement_v9_sanitized/data/robustness_edge_audit/README.md
- supplement_v9_sanitized/data/robustness_edge_audit/brightness_shift.png
...
- supplement_v9_sanitized/data/robustness_edge_audit/original.png
- supplement_v9_sanitized/data/robustness_edge_audit/viewpoint_proxy.png
- supplement_v9_sanitized/data/revision_20260922/README.md
- supplement_v9_sanitized/data/revision_20260922/event_fault_recovery_aggregate_v9.csv
- supplement_v9_sanitized/data/revision_20260922/event_fault_recovery_runs_v9.csv
- supplement_v9_sanitized/data/revision_20260922/event_requery_controls_v9.csv
- supplement_v9_sanitized/data/revision_20260922/event_requery_statistics_v9.csv
...
- supplement_v9_sanitized/source/main.py
- supplement_v9_sanitized/source/prompt_gpt.py
- supplement_v9_sanitized/source/requirements-runtime.txt
- supplement_v9_sanitized/source/requirements.txt
- supplement_v9_sanitized/source/sampler.py
- supplement_v9_sanitized/source/stage_experiments/audit_target_image_selection.py
...
- supplement_v9_sanitized/source/vlmpc.py
